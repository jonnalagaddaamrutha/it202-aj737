    ...
    <table border="1">
        <thead>
            <tr>
                ...
                <th>Subtotal</th>
                <th>Actions</th>
                <th>Product Detail</th> <!-- New column for Product Detail button -->
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            <tr>
                ...
                <td>
                    <a href="productdetail.php?id=<?php echo $item['product_id']; ?>">Product Detail</a>
                </td> <!-- Add Product Detail button -->
            </tr>
            <?php } ?>
            <tr>
